...
namespace GameHangman
{
    ...
    public class MainActivity : Activity
    {
        ...
        private HangmanPictureAnimator MyAnimator { get; set; }
        ...
        private DatabaseFunctions MyDataManager { get; set; }
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            MyDataManager =new DatabaseFunctions();
        ...
        private void NewGame()
        {
            ...
            MyAnimator = new HangmanPictureAnimator();
            DisplayImg.SetImageResource(MyAnimator.GetNextResource());
            RandomWordPicker myWordPicker = new RandomWordPicker(WordList);
